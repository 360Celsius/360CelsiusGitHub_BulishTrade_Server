...
for ($x = 0; $x <= count($arrayFiltered_10)-1 ; $x++) {
 echo "$arrayFiltered_5";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_10[$x]) .'/quote';
    $ch = curl_init($url);
