...
for ($x = 0; $x <= count($arrayFiltered_38)-1 ; $x++) {
    echo "$arrayFiltered";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_38[$x]) .'/quote';
    $ch = curl_init($url);
