...
for ($x = 0; $x <= count($arrayFiltered_84)-1 ; $x++) {
    echo "$arrayFiltered";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_84[$x]) .'/quote';
    $ch = curl_init($url);
