...
for ($x = 0; $x <= count($arrayFiltered_76)-1 ; $x++) {
    echo "$arrayFiltered";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_76[$x]) .'/quote';
    $ch = curl_init($url);
