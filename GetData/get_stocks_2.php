...
for ($x = 0; $x <= count($arrayFiltered_2)-1 ; $x++) {
 echo "$arrayFiltered_2";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_2[$x]) .'/quote';
    $ch = curl_init($url);
