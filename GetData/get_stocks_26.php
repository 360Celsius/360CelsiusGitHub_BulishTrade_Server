...
for ($x = 0; $x <= count($arrayFiltered_26)-1 ; $x++) {
    echo "$arrayFiltered";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_26[$x]) .'/quote';
    $ch = curl_init($url);
