...
for ($x = 0; $x <= count($arrayFiltered_3)-1 ; $x++) {
 echo "$arrayFiltered_3";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_3[$x]) .'/quote';
    $ch = curl_init($url);
