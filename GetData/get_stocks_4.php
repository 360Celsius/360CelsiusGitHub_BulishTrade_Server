...
for ($x = 0; $x <= count($arrayFiltered_4)-1 ; $x++) {
 echo "$arrayFiltered_4";
    $url = 'https://api.iextrading.com/1.0/stock/'. trim($arrayFiltered_4[$x]) .'/quote';
    $ch = curl_init($url);
